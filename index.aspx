...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" runat="Server">
    <asp:HyperLink Text="Log in" runat="server" CssClass="btn btn--stroke" ForeColor="White" BorderColor="White" ID="Login_Jmp_bt" OnClick="Login_Jmp_bt_Click" />
</asp:Content>
                ...
                <div class="bricks-wrapper">
                    ...
                    <article class="brick brick--double entry">
                        <a href="#modal-02" class="entry__link">
                            ...
                            <div class="entry__info">
                                <div class="entry__cat">Event Signup</div>
                                <h4 class="entry__title">活动报名</h4>
                            </div>
                        </a>
                    </article>
                    <!-- entry -->
        ...
        <div id="modal-01" hidden>
            <div class="modal-popup">
                ...
                <div class="modal-popup__desc">
                    <h5>元器件查询/借用管理系统</h5>
                    <p>借助此系统, 可自行查询已登记的元器件, 物联快速定位, 并在线登记借出。 <br />
                    返还元器件请交还给实验室成员并协助登记。</p>
