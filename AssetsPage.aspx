                            ...
                            <div class="row u-add-half-bottom">
                                ...
                                <div class="column lg-6 tab-12">
                                    <div class="row">
                                        ...
                                        <asp:LinkButton runat="server" class="btn btn--primary" href="#0" OnClick="bt_click('Search_bt_Click', 0, null);">搜索</asp:LinkButton>
                                    </div>
                                    <div class="row">
                                        <h5 style="position: relative; top: -39px; width: 150px">快捷查询</h5>
                                        <asp:LinkButton runat="server" class="btn btn--stroke" href="#0">待归还</asp:LinkButton>
                                        <asp:LinkButton runat="server" class="btn btn--stroke" href="#0">可续借</asp:LinkButton>
                                    </div>
                                ...
                                <div class="column lg-6 tab-12">
                                    ...
                                    <asp:Panel runat="server" ID="BorrowConfirm_pn">
                                        <asp:LinkButton runat="server" class="btn btn--primary u-fullwidth" href="#0">登记借出</asp:LinkButton>
                                    </asp:Panel>
                                    <asp:Panel runat="server" ID="BorrowNotAvailable_pn" Visible="false">
                                        <asp:LinkButton runat="server" class="btn u-fullwidth" href="#0">登记借出</asp:LinkButton>
                                    </asp:Panel>

                                    <asp:LinkButton runat="server" class="btn btn--stroke u-fullwidth" href="#0">元件定位</asp:LinkButton>
                                    <asp:Panel runat="server" Visible="false">
                                        ...
                                        <asp:LinkButton runat="server" class="btn btn--stroke u-fullwidth" href="#0">归还</asp:LinkButton>
                                    </asp:Panel>
                                </div>
        ...
        <footer id="footer" class="s-footer target-section">
            ...
            <div class="row section-header" data-num="Contact">
                ...
                <div class="column lg-6 stack-on-1100 section-header__primary">
                    <h2 class="title text-display-1"><b>DHU NUEDC实验室</b>
                        <br />
                        <br />
