                    ...
                    <div class="row u-add-half-bottom">
                        ...
                        <div class="column lg-6 tab-12">
                            ...
                            <div style="max-width: 100%; overflow-x: scroll">
                                <asp:GridView ID="Asset_gv" runat="server" Width="98%" AllowPaging="True" PageSize="15" HorizontalAlign="Left" SelectedRowStyle-BackColor="#FFCC99" SelectedRowStyle-BorderColor="#FF9900" SelectedRowStyle-ForeColor="Red" OnSelectedIndexChanged="Asset_gv_SelectedIndexChanged" OnRowCreated="Asset_gv_RowCreated"></asp:GridView>
                            </div>
