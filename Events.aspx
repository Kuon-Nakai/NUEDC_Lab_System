            ...
            <div class="column">
                ...
                <div class="row u-add-bottom u-fullwidth">
                    <div class="column">
                        ...
                        <asp:LinkButton runat="server" CssClass="btn btn--stroke u-fullwidth" Visible="false" ID="EditForm_bt" OnClick="EditForm_bt_Click">修改信息</asp:LinkButton>
                        <asp:LinkButton runat="server" CssClass="btn btn--stroke u-fullwidth" Visible="false" ID="Cancel_bt" OnClick="Cancel_bt_Click">取消报名</asp:LinkButton>
                        <br />
                        <hr />
                        <h3>活动介绍</h3>
